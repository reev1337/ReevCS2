...
#pragma region variables_visuals
	...
	C_ADD_VARIABLE(TextOverlayVar_t, overlayWeaponIcons, TextOverlayVar_t(false));
	...
	C_ADD_VARIABLE(TextOverlayVar_t, HKFlag, TextOverlayVar_t(true));
	C_ADD_VARIABLE(TextOverlayVar_t, KitFlag, TextOverlayVar_t(true));
	C_ADD_VARIABLE(TextOverlayVar_t, ScopedFlag, TextOverlayVar_t(true));
	C_ADD_VARIABLE(TextOverlayVar_t, DefuserFlag, TextOverlayVar_t(true));
	C_ADD_VARIABLE(bool, bBackTrackRender, false);
	...
	C_ADD_VARIABLE(bool, bPlayerModelChanger, false);
...
#pragma region variables_misc
	...
	C_ADD_VARIABLE(bool, bBulletTraceEnemy, false);
	C_ADD_VARIABLE(bool, bBulletTraceLocal, false);
	C_ADD_VARIABLE(Color_t, colBulletTraceEnemy, Color_t(255, 2555, 255));
	C_ADD_VARIABLE(Color_t, colBulletTraceLocal, Color_t(255, 255, 255));
...
#pragma region variables_menu
	...
	C_ADD_VARIABLE(unsigned int, nPanicKey, VK_F24);
...
C_ADD_VARIABLE(ColorPickerVar_t, colPrimtv0, ColorPickerVar_t(255, 255, 255));
	C_ADD_VARIABLE(ColorPickerVar_t, colPrimtv1, ColorPickerVar_t(0, 0, 0));
	C_ADD_VARIABLE(ColorPickerVar_t, colPrimtv2, ColorPickerVar_t(30, 30, 30));
	C_ADD_VARIABLE(ColorPickerVar_t, colPrimtv3, ColorPickerVar_t(20, 20, 20));
	C_ADD_VARIABLE(ColorPickerVar_t, colPrimtv4, ColorPickerVar_t(10, 10, 10));

	C_ADD_VARIABLE(ColorPickerVar_t, colAccent0, ColorPickerVar_t(170, 0, 255));
	C_ADD_VARIABLE(ColorPickerVar_t, colAccent1, ColorPickerVar_t(100, 30, 120));
	C_ADD_VARIABLE(ColorPickerVar_t, colAccent2, ColorPickerVar_t(200, 150, 255));
#pragma endregion
	#pragma region variables_triggerfov
	C_ADD_VARIABLE(bool, trigger, false);
	C_ADD_VARIABLE(float, flTriggerbotFov, 0.1f);
#pragma endregion

#pragma region variables_legitbot
	C_ADD_VARIABLE(bool, bLegitbot, false);
	C_ADD_VARIABLE(float, flAimRange, 10.0f);
	C_ADD_VARIABLE(float, iAimRange, 10.0f)
	C_ADD_VARIABLE(bool, AimFov, false);
	//	C_ADD_VARIABLE(bool, trigger, true);
	//C_ADD_VARIABLE(float, flTriggerbotFov, 5.0f);
	C_ADD_VARIABLE(bool, flTriggerRange, false);
	C_ADD_VARIABLE(Color_t, ColorFoV, Color_t(255, 255, 255, 255));
	C_ADD_VARIABLE(float, flSmoothing, 10.0f);
	C_ADD_VARIABLE(int, inttest, 10.0f);
	C_ADD_VARIABLE(bool, bLegitbotAlwaysOn, false);
	C_ADD_VARIABLE(bool, Silent, false);
	C_ADD_VARIABLE(unsigned int, nLegitbotActivationKey, VK_HOME);
	C_ADD_VARIABLE(unsigned int, iTargetBone, 6);
#pragma endregion
...
#pragma region variables_ragebot
	...
	C_ADD_VARIABLE(bool, bAutoScope, true);
...
#pragma region variables_viewmodel
	...
	C_ADD_VARIABLE(bool, bAspectRatio, false);
	C_ADD_VARIABLE(float, flAspectRatio, 1.77f);
