...
C_CSPlayerPawn* CCSPlayerController::GetPlayerPawn()
{
	...
	int nIndex = GetPlayerPawnHandle().GetEntryIndex();
...
void C_BaseModelEntity::SetModel(const char* szModelName)
{
	...
	static auto fnSetModel = MEM::FindPattern125(CLIENT_DLL, ("40 53 48 83 EC 20 48 8B D9 4C 8B C2 48 8B 0D ? ? ? ? 48 8D 54 24")).as<SetModel_t>();
