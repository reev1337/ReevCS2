...
void OVERLAY::Player(CCSPlayerController* pLocal, CCSPlayerController* pPlayer, const float flDistance)
{
	...
	if (const auto& nameOverlayConfig = C_GET(TextOverlayVar_t, Vars.overlayName); nameOverlayConfig.bEnable)
	{
		...
		context.AddComponent(new CTextComponent(false, SIDE_TOP, DIR_TOP, FONT::pEspPName, szPlayerName, Vars.overlayName));
	}
		CPlayer_WeaponServices* weapon_services = pPlayerPawn->GetWeaponServices();
	if (weapon_services)
	{
		auto ActiveWeapon = I::GameResourceService->pGameEntitySystem->Get<C_CSWeaponBase>(weapon_services->GetActiveWeapon());
		if (ActiveWeapon)
		{
			...
			auto szWeaponName = data->GetName();

			if (strcmp(szWeaponName, "NULL") == 0)
				return;
			...
			const char* extractedWeaponIcon = "";
			...
			// Knives
			if (strcmp(szWeaponName, "weapon_knife_t") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knife") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knife_bayonet") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knife_bowie") == 0)
				extractedWeaponIcon = "7";
			else if (strcmp(szWeaponName, "weapon_knife_butterfly") == 0)
				extractedWeaponIcon = "8";
			else if (strcmp(szWeaponName, "weapon_knife_knife") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knife_falchion") == 0)
				extractedWeaponIcon = "0";
			else if (strcmp(szWeaponName, "weapon_knife_flip") == 0)
				extractedWeaponIcon = "2";
			else if (strcmp(szWeaponName, "weapon_knife_gut") == 0)
				extractedWeaponIcon = "3";
			else if (strcmp(szWeaponName, "weapon_knife_huntsman") == 0)
				extractedWeaponIcon = "6";
			else if (strcmp(szWeaponName, "weapon_knife_karambit") == 0)
				extractedWeaponIcon = "4";
			else if (strcmp(szWeaponName, "weapon_knife_m9_bayonet") == 0)
				extractedWeaponIcon = "5";
			else if (strcmp(szWeaponName, "weapon_knife_navaja") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knife_nomad") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knife_paracord") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knife_skeleton") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knife_stiletto") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knife_survival") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knife_talon") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knife_ursus") == 0)
				extractedWeaponIcon = "1";
			else if (strcmp(szWeaponName, "weapon_knifegg") == 0)
				extractedWeaponIcon = "9";

			// Sniper rifles
			else if (strcmp(szWeaponName, "weapon_awp") == 0)
				extractedWeaponIcon = "Z";
			else if (strcmp(szWeaponName, "weapon_ssg08") == 0)
				extractedWeaponIcon = "a";

			// Pistols
			else if (strcmp(szWeaponName, "weapon_usp_silencer") == 0)
				extractedWeaponIcon = "G";
			else if (strcmp(szWeaponName, "weapon_glock") == 0)
				extractedWeaponIcon = "D";
			else if (strcmp(szWeaponName, "weapon_hkp2000") == 0)
				extractedWeaponIcon = "F";
			else if (strcmp(szWeaponName, "weapon_fiveseven") == 0)
				extractedWeaponIcon = "C";
			else if (strcmp(szWeaponName, "weapon_p250") == 0)
				extractedWeaponIcon = "E";
			else if (strcmp(szWeaponName, "weapon_deagle") == 0)
				extractedWeaponIcon = "A";
			else if (strcmp(szWeaponName, "weapon_elite") == 0)
				extractedWeaponIcon = "B";
			else if (strcmp(szWeaponName, "weapon_revolver") == 0)
				extractedWeaponIcon = "J";
			else if (strcmp(szWeaponName, "weapon_tec9") == 0)
				extractedWeaponIcon = "H";
			else if (strcmp(szWeaponName, "weapon_cz75a") == 0)
				extractedWeaponIcon = "H";

			// Rifles
			else if (strcmp(szWeaponName, "weapon_ak47") == 0)
				extractedWeaponIcon = "W";
			else if (strcmp(szWeaponName, "weapon_m4a4") == 0)
				extractedWeaponIcon = "S";
			else if (strcmp(szWeaponName, "weapon_m4a1_silencer") == 0)
				extractedWeaponIcon = "T";
			else if (strcmp(szWeaponName, "weapon_aug") == 0)
				extractedWeaponIcon = "U";
			else if (strcmp(szWeaponName, "weapon_famas") == 0)
				extractedWeaponIcon = "R";
			else if (strcmp(szWeaponName, "weapon_galilar") == 0)
				extractedWeaponIcon = "Q";
			else if (strcmp(szWeaponName, "weapon_sg556") == 0)
				extractedWeaponIcon = "V";

			// SMGs
			else if (strcmp(szWeaponName, "weapon_mp9") == 0)
				extractedWeaponIcon = "O";
			else if (strcmp(szWeaponName, "weapon_mac10") == 0)
				extractedWeaponIcon = "K";
			else if (strcmp(szWeaponName, "weapon_ppbizon") == 0)
				extractedWeaponIcon = "M";
			else if (strcmp(szWeaponName, "weapon_ump45") == 0)
				extractedWeaponIcon = "L";
			else if (strcmp(szWeaponName, "weapon_p90") == 0)
				extractedWeaponIcon = "P";
			else if (strcmp(szWeaponName, "weapon_mp5sd") == 0)
				extractedWeaponIcon = "x";

			// Shotguns
			else if (strcmp(szWeaponName, "weapon_nova") == 0)
				extractedWeaponIcon = "e";
			else if (strcmp(szWeaponName, "weapon_xm1014") == 0)
				extractedWeaponIcon = "b";
			else if (strcmp(szWeaponName, "weapon_mag7") == 0)
				extractedWeaponIcon = "d";
			else if (strcmp(szWeaponName, "weapon_sawedoff") == 0)
				extractedWeaponIcon = "c";

			// Grenades
			else if (strcmp(szWeaponName, "weapon_flashbang") == 0)
				extractedWeaponIcon = "i";
			else if (strcmp(szWeaponName, "weapon_smokegrenade") == 0)
				extractedWeaponIcon = "k";
			else if (strcmp(szWeaponName, "weapon_hegrenade") == 0)
				extractedWeaponIcon = "j";
			else if (strcmp(szWeaponName, "weapon_molotov") == 0)
				extractedWeaponIcon = "l";
			else if (strcmp(szWeaponName, "weapon_incgrenade") == 0)
				extractedWeaponIcon = "l"; /*or  n*/
			else if (strcmp(szWeaponName, "weapon_decoy") == 0)
				extractedWeaponIcon = "m";

			// Others
			else if (strcmp(szWeaponName, "weapon_taser") == 0)
				extractedWeaponIcon = "h";
			else if (strcmp(szWeaponName, "weapon_c4") == 0)
				extractedWeaponIcon = "o";

			else
				extractedWeaponIcon = "(*******)";

			if (C_GET(TextOverlayVar_t, Vars.overlayWeaponName).bEnable)
				context.AddComponent(new CTextComponent(false, SIDE_BOTTOM, DIR_BOTTOM, FONT::pEspName, extractedWeaponName, Vars.overlayWeaponName));

			if (C_GET(TextOverlayVar_t, Vars.overlayWeaponIcons).bEnable)
				context.AddComponent(new CTextComponent(false, SIDE_BOTTOM, DIR_BOTTOM, FONT::pEspIcons, extractedWeaponIcon, Vars.overlayWeaponIcons));
		}
	}
	...
	if (const auto& armorOverlayConfig = C_GET(BarOverlayVar_t, Vars.overlayArmorBar); armorOverlayConfig.bEnable)
	{
		...
		if (C_GET(unsigned int, Vars.pEspFlags) & FLAGS_ARMOR && pPlayerPawn->GetArmorValue() > 0 && C_GET(TextOverlayVar_t, Vars.HKFlag).bEnable)
	{
		const char* szName = CS_XOR("K");
		if (pPlayer->IsPawnHasHelmet())
			szName = CS_XOR("HK");
		context.AddComponent(new CTextComponent(false, SIDE_RIGHT, DIR_RIGHT, FONT::pEspFlagsName, szName, Vars.HKFlag));
	}

	if (C_GET(unsigned int, Vars.pEspFlags) & FLAGS_KIT && pPlayer->IsPawnHasDefuser() > 0 && C_GET(TextOverlayVar_t, Vars.KitFlag).bEnable)
		context.AddComponent(new CTextComponent(false, SIDE_RIGHT, DIR_BOTTOM, FONT::pEspFlagsName, CS_XOR("KIT"), Vars.KitFlag));

	if (C_GET(unsigned int, Vars.pEspFlags) & FLAGS_SCOPED && pPlayerPawn->IsScoped() > 0 && C_GET(TextOverlayVar_t, Vars.ScopedFlag).bEnable)
		context.AddComponent(new CTextComponent(false, SIDE_RIGHT, DIR_BOTTOM, FONT::pEspFlagsName, CS_XOR("SCOPED"), Vars.ScopedFlag));

	if (C_GET(unsigned int, Vars.pEspFlags) & FLAGS_DEFUSER && pPlayerPawn->IsDefusing() && C_GET(TextOverlayVar_t, Vars.DefuserFlag).bEnable)
		context.AddComponent(new CTextComponent(false, SIDE_RIGHT, DIR_BOTTOM, FONT::pEspFlagsName, CS_XOR("DEFUSING"), Vars.DefuserFlag));
